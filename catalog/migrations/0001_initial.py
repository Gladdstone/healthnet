    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2017, 4, 2, 0, 25, 50, 801853))),
            ],
            options={
                'ordering': ['time'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(blank=True, default=uuid.uuid4, max_length=100, unique=True)),
